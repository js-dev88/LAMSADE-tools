...
public class Test_GetInfosFromYearbook {
	...
	public void testGetInfosFromYearbookwithName() throws IOException, MalformedURLException {
		...
		Assert.assertTrue(prof.getCourrier().equals("olivier.cailloux@lamsade.dauphine.fr")
				&& prof.getFonction().equals("MAITRE DE CONFERENCES") && prof.getTelephone().equals("+33 1 44 05 46 53")
				&& prof.getGroupes().equals("MIDO - LAMSADE") && prof.getFax().equals("non renseign�")

...
import org.apache.pdfbox.examples.pdmodel.PapierAEnTeteGenerator;
...
public class TestGround {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			final PDImageXObject pdImage = PDImageXObject.createFromFile(pm.getDauphinelogoimage(), doc);
			final PDPageContentStream contentStream = new PDPageContentStream(doc, page, AppendMode.APPEND, true);

			// Add all images
			double scale = 0.15;
			ImageSize is = new ImageSize(pm.getDauphinelogoimage(), scale);

			pm.addImageToPdf(doc, contentStream, pdImage, "_" + pm.getFilename(), 20.0,
